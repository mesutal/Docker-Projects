...
variable "files" {
  default = ["bookstore.py", "requirements.txt", "Dockerfile", "docker-compose.yml"]
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          USER="mesutal"
          cd /home/ec2-user && git clone https://$TOKEN@github.com/$USER/bookstore-api-project.git
          cd /home/ec2-user/bookstore-api-project/
          docker build -t mesutal/bookstoreapi:latest .
          docker-compose up -d
          EOF
