...
app.config['MYSQL_DATABASE_USER'] = 'mesutal'
...
# Write a function named `home` which returns 'Welcome to the Mesut's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Mesut's Bookstore API Service"
